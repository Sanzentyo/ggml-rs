//! Synthetic GPT-2 context-path runner mirroring `main-ctx.cpp` execution style.

use clap::Parser;
use llama_rs::{SyntheticConfig, SyntheticError, run_ctx};
...
#[command(about = "Run synthetic GPT-2 context execution path", version)]
struct Cli {
