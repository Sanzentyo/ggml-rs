// Minimal fallback FFI surface used by the safe wrapper.
//
...
#[cfg(ggml_rs_autogen_ffi_consts)]
include!(concat!(env!("OUT_DIR"), "/ffi_generated_consts.rs"));

#[cfg(not(ggml_rs_autogen_ffi_consts))]
...
unsafe extern "C" {
    ...
    pub fn gguf_get_arr_str(ctx: *const gguf_context, key_id: i64, i: usize) -> *const c_char;
